...
> **LAST DANCE** is an unapologetic, brutalist high-fashion streetwear e-commerce application engineered with **Next.js 16 (App Router)**, **React 19**, **Prisma 7 & PostgreSQL**, **Stripe Checkout**, **NextAuth.js (v5)**, **Redis Rate Limiting**, and **AI Fashion Studio** (Generative AI via OpenRouter).
...
- **AI Fashion Studio**: OpenRouter API (`google/gemini-2.5-flash-image` / Nano Banana) generating multi-view editorial lookbooks
...
│   ├── admin/            # Brutalist Admin Dashboard (KPIs, products, orders, AI Studio)
...
└── modules/              # Domain-Driven Core Business Modules
    ...
    ├── ai-fashion/       # Generative AI lookbook generation pipeline
...
- **Multi-tiered Rate Limiting**: Redis-backed limits for login (per IP & per IP+email), registration, checkout attempts, and AI generation requests.
